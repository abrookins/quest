  ...
  render () {
    ...
    return <div className='your-goals'>
      <div className="learning-goals">
        ...
        <GoalsList moreUrl="/goals" goals={yourGoals} handleDelete={this.handleDelete} handleStart={this.handleStart} />
      </div>
      <div className="learning-goals">
        <h2 className="subtitle">Recommended Goals</h2>
        <GoalsList goals={recommendedGoals} handleDelete={this.handleDelete} handleStart={this.handleStart} />
      </div>
    </div>
  }
}
